    ...
    <body>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <?php echo $this->Html->image('/img/banners/1.png'); ?>
                        </div>
                        <div class="item">
                            <?php echo $this->Html->image('/img/banners/2.png'); ?>
                        </div>
                        <div class="item">
                            <?php echo $this->Html->image('/img/banners/3.png'); ?>
                        </div>
                    </div>
        ...
        <div class="rodape">
            <div class="rodape_nivel_1">
                <div class="max-largura">
                    <div class="col-xs-12 col-md-6">
                        <input type="text" placeholder="Newsletter" style="border: none; height: 36px; margin: 0; padding: 3px; width: 80%;" />
                    ...
                    <div class="col-xs-12 col-md-6 rodape_social">
                        <span style="background: #1F1F1F; margin: 0; padding: 5px; display: inline-block; height: 54px; ">
            ...
            <div class="rodape_nivel_2">
                <div class="max-largura">
                    <div class="col-xs-5 col-md-6 fonte texto_rodape">
                        Copyright &copy; PinheiroWeb 2013.<br />Designed by Felipe Faggion.
                    </div>
                    <div class="col-xs-7 col-md-6 rodape_social">
                        <?php echo $this->Html->link('HOME', '/', array('class' => 'texto_rodape fonte')); ?> | 
                        <?php echo $this->Html->link('EMPRESA', '/empresa', array('class' => 'texto_rodape fonte')); ?> | 
                        <?php echo $this->Html->link('SERVIÇOS', '/servicos', array('class' => 'texto_rodape fonte')); ?> | 
                        <?php echo $this->Html->link('CONTATO', '/contato', array('class' => 'texto_rodape fonte')); ?>
                    </div>
                </div>
